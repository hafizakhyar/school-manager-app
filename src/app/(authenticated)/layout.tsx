...
import { FileText, DownloadCloud, Users, TrendingUp, BookOpen, AlertTriangle } from "lucide-react";
...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      {/* KARTU DOKUMEN AKADEMIK TERBARU */}
      {!loadingFile && latestFile && (
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <h3 className="text-lg font-bold text-white">{latestFile.title}</h3>
